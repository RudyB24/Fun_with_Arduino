...
////////////////////////////////////////////////////////////////
// Function: detect encoder slow/fast rotation and return value 
////////////////////////////////////////////////////////////////
int read_encoder() {
  int increment;
  encA = digitalRead(ENCA_PIN);
  if((!encA_old) && (encA)) { // LH transition
    if     ((millis() - enc_rot_time) > ENC_SLOW_FAST) increment =  1;
    else if((millis() - enc_rot_time) > ENC_DEBOUNCE)  increment = 10;
    else                                               increment =  0;
    enc_rot_time = millis();
    encA_old = encA;
    if(digitalRead(ENCB_PIN)) return  increment;
...
void loop() {
//////////////////////////////////////////////////////////////
// Read the digital encoder, change and print enc_value 0~255
//////////////////////////////////////////////////////////////
