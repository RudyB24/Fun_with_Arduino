...
#define LED_POTMETER     1 // number of the LED to use for the potmeter analogRead value
#define LED_ENCODER      2 // number of the LED to use for the encoder value
...
//////////////////////////////////////////////////////////////////////////
  switch(st) {
    case 1: // read pushbuttons (pb) and switches (sw)
      if(pb[0]==1) st = 101; // Short press: move servo left / right
      if(pb[0]==2) st = 102; // Long press : move servo to 90
      if(pb[1]==1) dig_value[1] = 1; // Switch a LED on
      if(pb[1]==2) dig_value[1] = 0; // Switch a LED off
    ...
    break;
    case 101: // Toggle servo position left / right
